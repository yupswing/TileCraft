...
class BoxColorPicker extends Box {
    ...
    var _buttonClose:Button;
      ...
      _buttonClose.x = _colorPicker.width+style.padding+_colorPicker._padding-_buttonClose.width;
      _buttonClose.y = style.padding;
      addChild(_buttonClose);

      _colorPicker.x = style.padding-_colorPicker._padding;
      _colorPicker.y = style.padding-_colorPicker._padding+_buttonClose.height;
